/**
 * Ashima / Stefan Gustavson 3D simplex noise, MIT licensed.
 * https://github.com/ashima/webgl-noise
 *
 * Exported as a string so it can be spliced into any ShaderMaterial without a
 * build-time GLSL plugin. Every symbol is prefixed `sn_` so it can never clash
 * with a Three.js built-in shader chunk.
 */
...
/** Rotate a vec2 by `a` radians — used for the pointer-driven twist. */
export const rotate2d = /* glsl */ `
vec2 sn_rotate(vec2 p, float a) {
